...
fun <T : ValveHandleBlock, P> BlockBuilder<T, P>.valveBlockstate() =
    blockstate { context, provider ->
        val model =
            provider
                .models()
                .withExistingParent(context.name, CREATE.createId("block/valve_handle"))
...
fun <T : Item, P> ItemBuilder<T, P>.valveRecipe() =
